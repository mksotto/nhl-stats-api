...
export const makePlayersId = (
    ...
    careerStats: player.featuredStats ? {
        regular: player.featuredStats.regularSeason?.career ? {
            ...
            goalsAgainstAverage: makeRoundValue(player.featuredStats.regularSeason.playoffs?.goalsAgainstAvg, 2),
            savePctg: makeSavePctg(player.featuredStats.regularSeason.playoffs?.savePctg),
        } : null,
    ...
    seasonTotal: player.seasonTotals ? player.seasonTotals.map((season) => ({
        ...
        shots: season.shots,
        shootingPctg: makeRoundValue(season.shootingPctg, 1),
        faceoffWinningPctg: makeRoundValue(season.faceoffWinningPctg, 1),
